    ...
    <div className="flex flex-col md:w-3/12 lg:w-3/12 w-10/12 mx-auto text-gray-400 md:mt-4 mb-4">
      <div className="flex flex-row md:flex-col md:space-x-0 space-x-6 md:items-start items-center">
        <img
          src={user.avatar_url}
          alt="avatar"
          className="md:w-fit md:h-fit w-2/5 h-2/5 border-2 rounded-full justify-self-center mb-4"
        />
        <div>
      ...
      <button
        className="text-gray-400 border-gray-400 hover:border-gray-300 hover:text-gray-300 rounded-md border-2 md:px-3 md:py-1 items-center my-4
      ...
      <div className="flex flex-row items-center space-x-1 my-2">
        ...
        <div className="text-sm flex flex-row">
          <p className="font-semibold mr-1">{user.following}</p> Following
        </div>
      </div>
      {user.email && (
